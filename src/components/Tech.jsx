  ...
  return (
    <>
      <div variants={textVariant()}>
        ...
        <h2 className={`${styles.sectionHeadText} animate-text bg-[linear-gradient(to_right,#03045e,#0077b6,#00b4d8,#90e0ef,#caf0f8)] bg-clip-text text-transparent font-black text-center flux`}>Technologies.</h2>
